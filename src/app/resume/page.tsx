    ...
    <div className="min-h-screen bg-portfolio-dark text-white">
      ...
      <header className="bg-black bg-opacity-50 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-portfolio-green">Asad Arshad</h1>
          <button
            onClick={handleDownload}
            className="flex items-center gap-2 bg-portfolio-green text-black px-6 py-2 rounded-lg hover:bg-green-400 transition-colors font-semibold"
          >
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <ScrollAnimatedSection delay={200} direction="fade">
          <section className="mb-12">
            <div className="bg-portfolio-gray bg-opacity-50 backdrop-blur-sm rounded-xl p-8">
              <h2 className="text-4xl font-bold mb-4">Asad Arshad</h2>
              <p className="text-xl text-portfolio-green mb-6">Full Stack Developer & AI Specialist</p>
        ...
        <ScrollAnimatedSection delay={400} direction="left">
          <div className="bg-portfolio-gray bg-opacity-30 backdrop-blur-sm rounded-lg p-6 mb-8">
            <div className="flex items-center gap-4 mb-4">
              <User className="w-6 h-6 text-portfolio-green" />
        ...
        <ScrollAnimatedSection delay={800} direction="right">
          <section className="mb-12">
            <h3 className="text-2xl font-bold mb-6 text-portfolio-green">Technical Skills</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <ScrollAnimatedSection delay={1200} direction="up">
                <div className="bg-portfolio-gray bg-opacity-30 backdrop-blur-sm rounded-lg p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <Database className="w-6 h-6 text-portfolio-green" />
              ...
              <ScrollAnimatedSection delay={1100} direction="up">
                <div className="bg-portfolio-gray bg-opacity-30 backdrop-blur-sm rounded-lg p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <Code className="w-6 h-6 text-portfolio-green" />
                    <h4 className="font-semibold text-lg">Languages & Web Development</h4>
                  </div>
                  <div className="flex flex-wrap gap-2">
              ...
              <ScrollAnimatedSection delay={1100} direction="up">
                <div className="bg-portfolio-gray bg-opacity-30 backdrop-blur-sm rounded-lg p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <Server className="w-6 h-6 text-portfolio-green" />
        ...
        <ScrollAnimatedSection delay={1200} direction="up">
          <section className="mb-12">
            <h3 className="text-2xl font-bold mb-6 text-portfolio-green">Professional Experience</h3>
                ...
                <div className="bg-portfolio-gray bg-opacity-30 backdrop-blur-sm rounded-lg p-6">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      ...
                      <p className="text-portfolio-green">Concept, Sector I-9, Islamabad</p>
                    </div>
                ...
                <div className="bg-portfolio-gray bg-opacity-30 backdrop-blur-sm rounded-lg p-6">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      ...
                      <p className="text-portfolio-green">Insights, NSTP, Nust Islamabad - Remote</p>
                    </div>
                    <div className="flex items-center gap-1 text-sm text-gray-400">
                      <Calendar className="w-4 h-4" />
                      May 2024 - July 2024
        ...
        <ScrollAnimatedSection delay={1800} direction="fade">
          <section className="mb-12">
            <h3 className="text-2xl font-bold mb-6 text-portfolio-green">Education</h3>
            <div className="bg-portfolio-gray bg-opacity-30 backdrop-blur-sm rounded-lg p-6">
              <div className="flex justify-between items-start mb-3">
                <div>
                  <h4 className="font-semibold text-lg">BSc. Computer Science</h4>
                  <p className="text-portfolio-green">National University of Science and Technology, Islamabad</p>
                </div>
                <div className="flex items-center gap-1 text-sm text-gray-400">
                  <Calendar className="w-4 h-4" />
                  2024
        ...
        <ScrollAnimatedSection delay={2000} direction="up">
          <section>
            <h3 className="text-2xl font-bold mb-6 text-portfolio-green">Key Projects</h3>
            <div className="grid md:grid-cols-2 gap-6">
              <ScrollAnimatedSection delay={2200} direction="left">
                <div className="bg-portfolio-gray bg-opacity-30 backdrop-blur-sm rounded-lg p-6">
                  <h4 className="font-semibold text-lg mb-2">AI-Native Interactive Portfolio</h4>
              ...
              <ScrollAnimatedSection delay={2400} direction="right">
                <div className="bg-portfolio-gray bg-opacity-30 backdrop-blur-sm rounded-lg p-6">
                  <h4 className="font-semibold text-lg mb-2">Plant Disease Detection Using ML</h4>
                  <p className="text-gray-300 mb-3">
              ...
              <ScrollAnimatedSection delay={2600} direction="left">
                <div className="bg-portfolio-gray bg-opacity-30 backdrop-blur-sm rounded-lg p-6">
                  <h4 className="font-semibold text-lg mb-2">AI Autonomous Drone Navigation</h4>
                  <p className="text-gray-300 mb-3">
